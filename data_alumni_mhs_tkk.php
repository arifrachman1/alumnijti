            ...
            <div class="col-md-12 left-side">
              <div class="artikel">
                <div class="konten">
                  ...
                  $sql = "SELECT * FROM alumni WHERE ((nim LIKE '%$q%') OR (nama LIKE '%$q%') OR (angkatan LIKE '%$q%')) AND program_studi='Teknik Komputer' ORDER BY nama ASC";
                        ...
                        <div class="input-group">
                          ...
                          <div style="float: left;">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="data_alumni_mhs_tkk.php?angkatan=">Teknik Komputer (TKK)</a></li>
                              <li><a href="data_alumni_mhs_mif.php?angkatan=">Manajemen Informatika (MIF)</a></li>
                              <li><a href="data_alumni_mhs_tif.php?angkatan=">Teknik Informatika (TIF)</a></li>
                            </ul>
                          </div>
