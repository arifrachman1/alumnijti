                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="form-group">
                                        ...
                                        <input name="jenis_kelamin" type="radio" value="L" required="" <?php if($hasil['jenis_kelamin']=='L'){echo 'checked';}?>> Laki-Laki
                                        <input name="jenis_kelamin" type="radio" value="P" required="" <?php if($hasil['jenis_kelamin']=='P'){echo 'checked';}?>> Perempuan
                                      </div>
                                    </td>
                                  </tr>
                                  <tr>
