        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12" id="header-page">
              <h1><span> Info Loker JTI </span></h1>
            </div>
            <div class="col-md-12 left-side">
              <div class="artikel">
                <div class="konten">
                  ...
                  $sql = "SELECT * FROM postingan WHERE ((judul LIKE '%$q%') OR (isi LIKE '%$q%')) AND kategori='Info Loker' ORDER BY tgl_buat DESC"; // query silahkan disesuaikan
