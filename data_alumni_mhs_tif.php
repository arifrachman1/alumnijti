            ...
            <div class="col-md-12 left-side">
              <div class="artikel">
                <div class="konten">
                  ...
                  $sql = "SELECT * FROM alumni WHERE ((nim LIKE '%$q%') OR (nama LIKE '%$q%') OR (angkatan LIKE '%$q%')) AND program_studi='Teknik Informatika' ORDER BY nama ASC"; // query silahkan disesuaikan
